...
public class PnlKruskal extends javax.swing.JPanel {
    ...
    protected void paintComponent(Graphics g) {
       ...
       // 1. Dibujar todas las aristas en gris claro
       g2d.setColor(new Color(200, 200, 200));
       dibujarAristas(g2d, false, false);

       // 2. Dibujar aristas evaluadas en amarillo
       g2d.setColor(Color.ORANGE);
       dibujarAristas(g2d, true, false);

       // 3. Dibujar aristas del MST en rojo (al final para que sobresalgan)
       g2d.setColor(new Color(208, 104, 119));
       g2d.setStroke(new BasicStroke(3));
       dibujarAristas(g2d, false, true);
       g2d.setStroke(new BasicStroke(1));

       // 4. Dibujar nodos y texto
       dibujarNodos(g2d);
